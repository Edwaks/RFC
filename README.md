...
**AiSDocs** — библиотека канонов и согласованных документов. Продукт рассчитан на команды, которым важно единообразие решений и терминов и делает действующие правила, решения и связи между ними доступными для поиска.

- Публичный адрес: https://rfc.aisaray.ru/
- Основные сущности: каноны, документы, редакции, темы, ссылки, статусы и области действия.
- Ключевые возможности: каталог документов, поиск канона, тематические разделы, карточка документа, связи материалов, статус редакции и навигация по библиотеке.

## Зачем нужен продукт

Рабочий процесс редко состоит из одного действия. Пользователю приходится понимать исходную ситуацию, собирать сведения, выбирать следующий шаг, согласовывать решение и возвращаться к результату позже. AiSDocs создаёт для этого единое предметное пространство. Оно помогает не терять контекст между этапами и видеть не только отдельную карточку, но и её место в общем процессе.

Главная ценность продукта — не количество экранов, а связность работы. Каноны, документы, редакции, темы, ссылки, статусы и области действия рассматриваются как части одного пользовательского маршрута. Благодаря этому новый участник быстрее понимает состояние дела, опытный специалист тратит меньше времени на ручное сопоставление, а руководитель получает обозримую картину без пересказа каждого шага.
...
Роли Читатель, Автор документа и Ответственный за канон работают с одной предметной моделью, хотя видят её с разных сторон. Единые названия объектов и состояний уменьшают двусмысленность при передаче работы. Ответственный участник может сослаться на конкретный объект и ожидаемый результат, а не пересказывать весь контекст.

## Основные разделы

Публичное описание охватывает следующие пользовательские возможности:

- **Каталог документов** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Поиск канона** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Тематические разделы** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Карточка документа** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Связи материалов** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Статус редакции** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Навигация по библиотеке** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
